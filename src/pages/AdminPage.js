...
import { BellIcon, UserIcon, ChevronDoubleUpIcon, ChevronDoubleLeftIcon } from '@heroicons/react/outline';
...
function AdminPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-white md:flex-row">
      ...
      <div className={`flex-1 p-4 md:p-6 transition-all duration-300 ${isOpen ? 'mix-blend-screen' : 'ml-0'}`}>
        {/* Header Section */}
        <div className='flex justify-between items-center mb-10 gap-4 bg-gradient-to-r from-blue-400 to-purple-500 text-white p-4 rounded shadow'>
