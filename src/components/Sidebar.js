...
function Sidebar({ role, isOpen, toggleSidebar }) {
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-indigo-700 to-indigo-900 text-white flex flex-col p-4 h-full transition-transform duration-300 ease-in-out shadow-lg z-50 ${
    ...
    >
      ...
      <button
        ...
        className="flex items-center space-x-2 bg-red-500 p-2 rounded hover:bg-red-600 transition duration-300"
      >
